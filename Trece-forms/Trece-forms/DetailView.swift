...
struct DetailView_Previews: PreviewProvider {
    static var previews: some View {
        DetailView(deportiva: Deportiva(name: "BMW S1000RR", image: "BMW", type: "alemana", priceLevel: 4)) //aquí de momento le he pasado estos dos parámetro inventados para que no de error
    }
}
